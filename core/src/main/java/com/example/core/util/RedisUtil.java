...
public class RedisUtil {
    ...
    public Long bitAnd(String destKey, String... keys){
        ...
        return redisTemplate.execute((RedisCallback<Long>) connection -> connection.bitOp(RedisStringCommands.BitOperation.AND, destKey.getBytes(), bytes));
    }
    ...
    public Long bitOr(String destKey, String... keys){
        ...
        return redisTemplate.execute((RedisCallback<Long>) connection -> connection.bitOp(RedisStringCommands.BitOperation.OR, destKey.getBytes(), bytes));
    }
